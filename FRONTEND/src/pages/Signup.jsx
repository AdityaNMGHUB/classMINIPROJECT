...
import { ArrowRight, Mail, Lock, User, AlertCircle, Smartphone } from 'lucide-react';
    ...
    <div className="min-h-screen pt-28 pb-20 flex items-center justify-center bg-gray-50 px-4">
      <div className="bg-white p-8 md:p-10 rounded-3xl shadow-sm border border-gray-100 w-full max-w-md">
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            type="button"
            className="flex items-center justify-center gap-2 w-full border border-gray-200 hover:bg-gray-50 h-12 rounded-xl font-semibold text-gray-700 transition-colors"
          >
